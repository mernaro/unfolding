from models.Neumann import NeumannUnfolding
...
if __name__ == '__main__' :
    ...
    parser.add_argument("-c", "--config",
                        help="Path to a specific config. Default: /projects/memaro/mcodjo/unfolding/config.json",
                        default="/projects/memaro/mcodjo/unfolding/config.json")
    ...
    if action == "train" :
        ...
        model = NeumannUnfolding.from_config(config)
        ...
        train(model,optimizer,criterion,train_loader,val_loader,nb_epochs,patience,output_dir)
